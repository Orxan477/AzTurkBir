...
var tinyMCEPopup = {
   ...
   *
   * @method getLang
   * @param {String} name Languages item like mydialog.something.
   * @param {String} defaultValue Optional default value to return.
   * @return {String} Languages value for the item like "my string" or the default value if it wasn't found.
   */
